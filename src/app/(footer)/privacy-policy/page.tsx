export default function PrivacyPolicy() {
    return (
        <div>
            ...
            <h2 className="text-align: center;"><b>PRIVACY POLICY</b></h2>
            <p>Effective date: 2024-10-22</p>
            <p>1. <b>Introduction</b></p>
            <p>Welcome to <b> fail-archive.run</b>.</p>
            <p><b>fail-archive.run</b> (“us”, “we”, or “our”) operates <b>fail-archive.run</b> (hereinafter referred to as <b>“Service”</b>).</p>
            <p>Our Privacy Policy governs your visit to <b>fail-archive.run</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <p><b>SERVICE</b> means the fail-archive.run website operated by fail-archive.run.</p>
            ...
            <p>fail-archive.run uses the collected data for various purposes:</p>
            ...
            <p>fail-archive.run will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            ...
            <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>tkappdevelop@gmail.com</b>.</p>
            ...
            <p>0.4. users are able to change their personal information by emailing us at <b>tkappdevelop@gmail.com</b>.</p>
            ...
            <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>tkappdevelop@gmail.com</b>.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us by email: <b>tkappdevelop@gmail.com</b>.</p>
            <p className="margin-top: 5em; font-size: 0.7em;">This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created for <b>fail-archive.run</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2024-10-22.</p>
